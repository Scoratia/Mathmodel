...
public class Q4P3 {
    ...
    static void caseRun(String name, int nel, double rtol, double tend, double dtout) {
        try {
            ...
            m.component("comp1").variable("var1").set("Da",
                    "2.4e-3*exp(-0.45/u)*exp(-3850/(u2+273.15))");
            m.component("comp1").variable("var1").set("rhoa", "650+128*u");
            m.component("comp1").variable("var1").set("cpa", "1450+2736*u/(u+1)");
            m.component("comp1").variable("var1").set("ka", "0.21+0.38*u/(u+1)");
    ...
    public static Model run() {
        ...
        caseRun("p3", 160, 1e-4, 1296000, 600);
